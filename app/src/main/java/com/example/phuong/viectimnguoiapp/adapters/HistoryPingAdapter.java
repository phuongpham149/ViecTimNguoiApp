 ...
 */
public class HistoryPingAdapter extends RecyclerView.Adapter<HistoryPingAdapter.ItemHolder> {
    private List<HistoryPing> mHistoryPings;
    private Context mContext;
    private DatabaseReference mUserRef;

    public HistoryPingAdapter(List<HistoryPing> mHistoryPings, Context mContext) {
    ...
    public ItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_history_ping, parent, false);
